...
(function () {
    ...
    function insertSingle() {
        ...
        var hl=g('hotlink').value;
        if(hl && hl!='') imgObj.hotlink = hl;
        else imgObj.hotlink='';
    ...
    function showImageInfo(img) {
        ...
        g('hotlink').value=img.getAttribute('hotlink')||'';
    ...
    function showPreviewImage(img, needClone) {
        ...
        preview.innerHTML = '<div onclick="showHotlink();" style="cursor:pointer;position: absolute;z-index:999;margin-left:50px;margin-top:90px;background-color:#e0ffdc;color:red;border;1px red dotted;padding:5px;opacity: 0.6;font-size:16px;font-weight:bold;">点击此处设置热区..</div>'+
            '<img id="zltImg" src="' + target.src + '" width="' + target.width + '" height="' + target.height + '" border="' + target.border + 'px solid #000" />';
    }
