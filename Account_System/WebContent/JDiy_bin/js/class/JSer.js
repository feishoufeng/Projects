(function() {
    /********************************************************************
     **  JSer(v2.9)  -  a lightweight js framework. and GPL license.
     **  -----------------------------------------------------
     **  @author     : 子秋(ziquee)
     **  @qq         : 39886616
     *   @Document   : http://www.jdiy.org/jser-doc/
     **  @copyright  : http://www.jdiy.org
     **  @Lastmodified: 20140611
     **
     *********************************************************************/
    ...
    Element.prototype = {
        ...
        text: function(text){
            if (text !== undefined ){
                var a = (this[0] && this[0].ownerDocument || document).createTextNode( text );
                return this.empty().each(function(){this.appendChild(a)});
